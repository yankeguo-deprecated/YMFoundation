 ...
 */
extern YMBOOLBlock __nonnull YMAsyncCreateOnceBlock(YMVoidBlock __nonnull inputBlock);
 ...
 */
extern YMCompareBlock __nonnull YMAsyncCreateAllBlock(NSUInteger count, YMVoidBlock __nonnull inputBlock);