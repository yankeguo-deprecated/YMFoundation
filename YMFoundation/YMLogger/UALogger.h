...
typedef enum {
  UALoggerSeverityUnset =
  0,        // Unset means it is not factored in on the decision to log, defaulting to the production vs debug and user overrides.
...
static NSString
    *const UALogger_LoggingEnabled = @"UALogger_LoggingEnabled";    // This is the default NSUserDefaults key
